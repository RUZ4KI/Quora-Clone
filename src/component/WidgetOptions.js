...
function WidgetOptions() {
    return (
        <div className="widgetOptions">
            ...
            <div className="widgetOption">
                 <img src="https://qphs.fs.quoracdn.net/main-thumb-ti-1574818-100-mzdwostcualpwcxekyrvyqqpychetdoc.jpeg" alt=""/>
                 <div className="widget__optionTitle">
            ...
            <div className="widgetOption">
                 <img src="https://qphs.fs.quoracdn.net/main-thumb-ti-1644613-100-ydflucgoeztbhwyurtmlqqrgfqmjmhpl.jpeg" alt=""/>
                 <div className="widget__optionTitle">
            ...
            <div className="widgetOption">
                 <img src="https://qphs.fs.quoracdn.net/main-thumb-ti-1647318-100-kmwvqbpzatmylibelrowrerfqbspekwo.jpeg" alt=""/>
                 <div className="widget__optionTitle">
            ...
            <div className="widgetOption">
                 <img src="https://qphs.fs.quoracdn.net/main-thumb-ti-1578647-100-xkggvbyzfkvzhyklewtkjijefekqbazb.jpeg" alt=""/>
                 <div className="widget__optionTitle">
